...
%% one output (for example, the output is expecting the desired response that can be calculated 
% using the formula: y = (1 + 0.6 * sin (2 * pi * x / 0.7)) + 0.3 * sin (2 * pi * x)) / 2; 
% - the neural network being created should "model / simulate the behavior of this formula"
...
%% One hidden layer with hyperbolic tangent 
